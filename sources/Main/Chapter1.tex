...
I present below a demonstration of the bugs regarding the branch and link instruction and the integer comparisons:

\begin{figure}[H]
	\centering
	\subfigure[BL writes the wrong address to LR]{\includegraphics[width=.45\textwidth]{img/br_bug_1.png}}
	\subfigure[Jumps to label and increments X0]{\includegraphics[width=.45\textwidth]{img/br_bug_2.png}}
	\subfigure[Reads wrong address from LR]{\includegraphics[width=.45\textwidth]{img/br_bug_3.png}}
	\subfigure[Returns to wrong address]{\includegraphics[width=.45\textwidth]{img/br_bug_4.png}}
...
\begin{figure}[H]
	...
	\subfigure[Comparison fails]{\includegraphics[width=.45\textwidth]{img/cmp_bug_2.png}}
...
For these reasons then this simulator was chosen as the subject of my thesis:
