...
\begin{figure}[h!]\label{fig:example}
	\centering
	%\subfigure[Subfigure 1]{\includegraphics[width=.45\textwidth]{img/legv8_instruction_set.png}
	%\subfigure[Subfigure 2]{\includegraphics[width=.45\textwidth]{img/armv8_instruction_set.png}}
