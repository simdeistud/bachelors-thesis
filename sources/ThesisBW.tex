...
\lstset{
	...
	commentstyle=\color{mygray},    % Custom color for comments
	keywordstyle=\textit,       % Custom color for keywords
	numberstyle=\tiny\color{mygray}, % Custom color for line numbers
	stringstyle=\color{mygray},    % Custom color for strings
